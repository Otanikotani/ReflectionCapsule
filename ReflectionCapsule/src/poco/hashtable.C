...
int
POCO_Hashtable::put(const char* key, void* value)
{
...
void*
POCO_Hashtable::get(const char* key)
{
    if (key == NULL)
    {
        return NULL;
...
void*
POCO_Hashtable::remove(const char* key)
{
    if (key == NULL)
    {
        return NULL;
...
int
POCO_Hashtable::containsKey(const char* key)
{
    if (key == NULL)
    {
        return 0;
...
int
POCO_Hashtable::count()
{
    return _cnt;
}

const char**
POCO_Hashtable::allKeys()
{
    if (_cnt == 0)
    {
        return NULL;
...
POCO_ULong
POCO_Hashtable::_offsetOf(const char* key)
{
...
POCO_ULong
POCO_Hashtable::_hash(const char* key)
{
    if (key == NULL)
    {
        return 0UL;
...
POCO_ULong
POCO_Hashtable::_setSize(POCO_ULong n)
{
    _cnt = 0;
    _shift_bits = 0;
